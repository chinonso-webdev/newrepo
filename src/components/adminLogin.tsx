...
export default function AdminLoginComponent() {
    ...
    return <>
        <div className="h-screen md:grid md:grid-cols-2">
            <div
                className="relative overflow-hidden md:flex w-full bg-gradient-to-tr from-blue-800 to-purple-700 i justify-around items-center">
                <div className="py-10 md:py-0">
                    <h1 className="text-white font-bold text-4xl font-sans text-center md:text-left">QFS Asset Ledger</h1>
                    <p className="text-white mt-1 text-center md:text-left">The actual biggest boy Wallet ever</p>
                    <Link href={'/'}>
                        <button className="block w-28 bg-white text-indigo-800 mt-4 py-2 rounded-2xl font-bold mb-2 mx-auto md:mx-0">Read More</button>
                    </Link>
                </div>
