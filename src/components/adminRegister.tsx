        ...
        <div className="h-screen md:grid md:grid-cols-2">
            <div className="mx-auto md:w-1/2 justify-center py-10 items-center bg-white px-2 md:px-0">
                <form className="bg-white" onSubmit={handleSubmit}>
                    <h1 className="text-gray-800 font-bold text-2xl mb-1 text-center md:text-left">Create Admin!</h1>
                    ...
                    <div className="flex items-center border-2 py-2 px-3 rounded-2xl">
                        ...
                        <input className="pl-2 outline-none border-none" type="password" name="password" id="" placeholder="Password" required />
                    </div>
